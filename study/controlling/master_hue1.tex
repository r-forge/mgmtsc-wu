...
\usepackage{fancyhdr}
\pagestyle{fancy}
\lfoot{Gerold Köb (0250001), Stefan Theussl (0352689), Matthias Vogl (0352384), Martin Gartner (0351427)}
\cfoot{}
\rfoot{}
...
\title{\textbf{Aufgabe 1:}\\Branchenanalyse der Bauindustrie aus Sicht der \\\emph{Allgemeinen Baugesellschaft - A. PORR AG}\\ \includegraphics[width = 0.4 \textwidth]{logo.eps}}
...
Folgenden Aufgau hätte ich mir vorgestellt (eventuell könnten wir noch irgendwo einen Punkt \emph{Konjunktur} einbauen):

\section{Beschreibung der Branche}
