...
\begin{itemize}
\item Umsatzerlöse = Absatzmenge $\times$ Verkaufspreis (inkl. USt)

\item Rabatt = Bruttoerlöse (exkl. USt) $\times ~  5~ \% $

\item Skonto = Zielerlöse $\times$ 1~\%

\item Vertreterprovision = Nettoerlöse $\times$ 3~\%
...
\item kalkulatorische Abschreibung = $68,750 + 84,000 + 50,000~=~202,750$
  ...
  \item Maschine 4:\\
    \textbf{keine Abschreibung wegen Veräußerung???}
  \item neue Anlage:\\
...
\item kalkulatorische Zinsen des Anlagevermögens~=~BW~Maschinen~Anfang~2007~$\times~8~\%$

\item kalkulatorische Zinses des Umlaufvermögens~=~(AB~Material~-~EB~Material)~$/~2$ = $(150,000 + 50,000) / 2 $\\
...
\item Versicherungen (enthalten in kalk. Wagnissen) =
  2 Monate von Prämiensumme 48,000 und 10~Monate von Prämiensumme 54,000\\
